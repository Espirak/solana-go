...
[![GoDoc](https://pkg.go.dev/badge/github.com/Espirak/solana-go?status.svg)](https://pkg.go.dev/github.com/Espirak/solana-go@v1.12.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/Espirak/solana-go/releases)
[![Build Status](https://github.com/Espirak/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/Espirak/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/Espirak/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/Espirak/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/Espirak/solana-go)](https://goreportcard.com/report/github.com/Espirak/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/Espirak/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/Espirak/solana-go@v1.12.0
```
...
You can wait for a transaction confirmation using the `github.com/Espirak/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/Espirak/solana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/Espirak/solana-go"
  "github.com/Espirak/solana-go/programs/system"
  "github.com/Espirak/solana-go/rpc"
  "github.com/Espirak/solana-go/text"
)
...
import (
  ...
  "github.com/Espirak/solana-go/rpc"
  "github.com/Espirak/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/Espirak/solana-go/programs/system"
  "github.com/Espirak/solana-go/rpc"
  confirm "github.com/Espirak/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/Espirak/solana-go/rpc/jsonrpc"
  "github.com/Espirak/solana-go/rpc/ws"
  "github.com/Espirak/solana-go/text"
)
...
import (
  ...
  "github.com/davecgh/go-spew/spew"
  bin "github.com/gagliardetto/binary"
  solana "github.com/Espirak/solana-go"
  "github.com/Espirak/solana-go/programs/token"
  "github.com/Espirak/solana-go/rpc"
)
